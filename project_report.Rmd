...
Based on the ANOVA results above, Model 3 has the lowest AIC and BIC among all the three models, and p-value of the chi-square test is less than 0.05, meaning adding those body measurements variables into the model 3 is statistically significant, and model 3 is the best model. We can also plot the residual vs fitted plot and QQ plot to test for goodness-of-fit:
